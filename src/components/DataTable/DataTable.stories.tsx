...
export const CustomColumnsWidth = {
  render: Template,
...
export const CustomPaperHeight = {
  render: Template,
...
export const SortingOnSingleValue = {
  render: Template,
...
export const SortSomeColumnsOnly = {
  render: Template,
...
export const ManualControlledSort = {
  render: Template,
...
export const SingleItemsAction = {
  render: Template,
...
export const LongTitles = {
  ...
  args: {
    ...
    columns: [
      ...
      {
        label:
          "Super long title name for a single column that needs to truncate",
        elementKey: "field1",
      },
      { label: "Column2", elementKey: "field2" },
      {
