    ...
    children: (
      <div>
        ...
        <p>
          ...
          byte-- a particle of magic that combines and multiplies unseen inside
          the blinking box.
        </p>
        <p>
        ...
        <p>
          ...
          hopes, ideas are born and nurtured into happenings. Strangers share a
          table, touch hands across the world.
        </p>
        <p>
