...
export const ErrorInputWithOverlay = {
  render: Template,
...
export const WithOverlayObject = {
  render: Template,
...
export const StartIconWithAction = {
  render: Template,
